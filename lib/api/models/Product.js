...
exports.ProductType = exports.AvailabilityType = exports.getCsvTypeFromIndex = exports.CsvTypes = exports.PromotionType = exports.VideoCreatorType = void 0;
/**
...
function getCsvTypeFromIndex(index) {
    var _a, _b;
    return ((_b = (_a = Object.entries(exports.CsvTypes).find(([, v]) => v.index === index)) === null || _a === void 0 ? void 0 : _a[0]) !== null && _b !== void 0 ? _b : 'AMAZON');
}
